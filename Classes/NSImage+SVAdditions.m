...
#import "NSImage+SVAdditions.h"

@implementation NSImage (SVAdditions)
...
// Note: BWToolKit used deprecated methods here, they have been replaced with better equivalents.
...
- (NSImage *)bwRotateImage90DegreesClockwise:(BOOL)clockwise
{
    ...
    //
    existingImage = [[existingImage representations] objectAtIndex:0];
    existingSize.width = [(NSImageRep *)existingImage pixelsWide];
    existingSize.height = [(NSImageRep *)existingImage pixelsHigh];
    ...
    existingImage = [[existingImage representations] objectAtIndex:0];
    [(NSImageRep *)existingImage drawInRect:r1];
