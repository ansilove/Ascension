...
#import "SVTransparentButtonCell.h"
...
@interface NSCell (SVTBCPrivate)
- (NSDictionary *)_textAttributes;
@end

@interface SVTransparentButtonCell (SVTBCPrivate)
- (NSColor *)interiorColor;
@end

@implementation SVTransparentButtonCell

+ (void)initialize;
{
	NSBundle *bundle = [NSBundle bundleForClass:[SVTransparentButtonCell class]];
...
{	
	...
	if ([image isTemplate])
		newImage = [image svTintedImageWithColor:[self interiorColor]];
